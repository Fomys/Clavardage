...
public class JLabelSpe extends JPanel{
    ...
    private static ArrayList<JLabelSpe> all_component = new ArrayList<>();
    public JLabelSpe(String name, int width) throws IOException {
        ...
        SousJText txtPseudonyme = new SousJText(this, name, (int) (width*0.2) , (int) (height * 0.05), (int) (width * 0.50), height/2, true, false, false, true);
    ...
    public void changeColor() {
        for (JLabelSpe jLabelSpe : all_component) {

            Color gris = new Color(45, 45, 45);
            jLabelSpe.setBackground(gris);
            jLabelSpe.txtPseudonyme.setBackground(gris);
            jLabelSpe.txtDernierMessage.setBackground(gris);
            jLabelSpe.txth.setBackground(gris);
            jLabelSpe.txtPseudonyme.setForeground(Color.WHITE);
            jLabelSpe.txtDernierMessage.setForeground(new Color(160, 160, 160));
            jLabelSpe.txth.setForeground(new Color(160, 160, 160));
        }
